...
use std::sync::Arc;
use arrow::array::{UInt64Array, UInt64Builder, StringBuilder, UInt32Builder, StringArray, Int64Builder, Float64Builder, BooleanBuilder, ArrayRef};
use arrow::ipc::writer::StreamWriter;
use std::collections::HashMap;
use arrow::json::LineDelimitedWriter;
use crate::span::infer_span_schema;
use crate::attribute::add_attribute_columns;
...
fn serialize_spans(spans: &[Span]) -> Result<Vec<u8>, ArrowError> {
...
fn serialize_events(spans: &[Span]) -> Result<Vec<u8>, ArrowError> {
    let span_schema = infer_span_schema(&spans);
